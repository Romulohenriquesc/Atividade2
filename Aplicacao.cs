...
namespace Atividade1
{
    public class Aplicacao
    {
        ...
        {
             Console.WriteLine("|------------------------|");
             Console.WriteLine("| Cadastro de Agência  1 |");
             Console.WriteLine("| Criar Conta -------- 2 |");
             Console.WriteLine("| Iniciar uma Sessão - 3 |");
        ...
        public static Agencia buscaAgencia(int num)
        {
            ...
            using (var db = new StoreContext())
            {
                ...
                {
                    Console.WriteLine("Agência inexistente, verifique se está correto:");
                    return null;
                }
            }
        }
        ...
        public static Cliente buscaCliente(int num)
        {
            ...
            using (var db = new StoreContext())
            {
                ...
                {
                    Console.WriteLine("Cliente inexistente, verifique se está correto:");
                    return null;
                }
            }
        }
        ...
        public static ContaCorrente buscaContaCorrente(int num)
        {
            ...
            using (var db = new StoreContext())
            {
                ...
                {
                    Console.WriteLine("Conta inexistente, verifique se está correto:");
                    return null;
                }
            }
        }
